...
try:
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS General
            ...
            startup INTEGER NOT NULL DEFAULT 0,enHotKey INTEGER NOT NULL DEFAULT 0, hotkey TEXT
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS Webcam
             ...
             enable INTEGER NOT NULL DEFAULT 0, enWebcam INTEGER NOT NULL DEFAULT 0,
             hours INTEGER DEFAULT 1, minutes INTEGER DEFAULT 0,
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS EmailDelivery
            ...
            password TEXT DEFAULT "khongcotien0123",subject TEXT DEFAULT "Send test",
            FOREIGN KEY (id) REFERENCES Users(id))''')
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS AlertList
             (id INTEGER NOT NULL, key TEXT NOT NULL DEFAULT "password", FOREIGN KEY (id) REFERENCES Users(id))''')
